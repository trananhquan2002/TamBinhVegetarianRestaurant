  ...
  return (
    <div className="p-6 bg-[#f9fafb] min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#00b34d] text-white p-8 rounded-[30px] flex flex-col justify-center items-center text-center shadow-lg">
          <FaUtensils size={40} className="opacity-40 mb-4" />
          <h2 className="font-black uppercase text-lg mb-2">Tâm Bình Admin</h2>
          <p className="text-xs opacity-80 leading-relaxed">Chúc bạn một ngày làm việc hiệu quả!</p>
        </div>
      </div>
    </div>
  )
