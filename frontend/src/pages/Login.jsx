  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-cyan-400 via-purple-500 to-indigo-700 px-4">
      <form onSubmit={handleLogin} className="bg-white rounded-xl shadow-xl p-6 w-full max-w-sm space-y-4">
        ...
        <button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 rounded cursor-pointer">Đăng nhập</button>
        <div className="text-center">
          <Link to="/register">
            <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg transition duration-200 cursor-pointer">Tạo tài khoản mới</button>
          </Link>
        </div>
      </form>
    </div>
